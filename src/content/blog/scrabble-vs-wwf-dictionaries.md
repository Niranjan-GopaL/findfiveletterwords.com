...
The disagreements cluster in exactly the words competitive players care about:

- **Short power words.** ZA and QI are good in TWL and CSW. Some older digital games on ENABLE-derived lists rejected them for years.
...
The letter values aren't identical either. Scrabble's famous valuations (Q and Z at 10) shift in Words With Friends, where J costs 10 but B, C and F are worth more than Scrabble pays. A rack that's gold in one game is silver in the other.
...
Our word lists show Scrabble points by default; the finder switches to WWF values automatically when you select the WWF dictionary.

## What should you study?

Match your study list to where you actually play:

- **App Scrabble or US clubs** → TWL. Start with the [two-letter words](/2-letter-words/) and [three-letter words](/3-letter-words/).
- **International or UK play** → CSW. Same study order, bigger list.
- **Words With Friends** → the ENABLE-based list; almost everything in our default [word lists](/word-lists/) is safe to play there.

And if you just want to win arguments at the kitchen table: bookmark the finder, set the dictionary to whatever the box says, and let the lookup be the referee.
